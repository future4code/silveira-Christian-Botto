...
import { MainContainerDiaDeSorte as MainContainer }from "../../styles/styled";
...
function DiaDeSortePage() {
  ...
  return (
    <MainContainer>
      ...
      <DivRest>
        <DropDown>
          <DropDownButton ><option>Dia de Sorte</option></DropDownButton>
          <DropDownMenu>
            <a onClick={() => goToMegaSenaPage(navigate)}>Mega Sena</a>
            <a onClick={() => goToLotoFacilPage(navigate)}>Loto Facil</a>
            <a onClick={() => goToLotoManiaPage(navigate)}>Loto Mania</a>
